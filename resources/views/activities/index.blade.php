                                    ...
                                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-8 gap-4 items-end">
                                        ...
                                        <div>
                                            ...
                                            <select name="project_uuid" class="w-full text-sm rounded-md border-gray-300 shadow-sm focus:border-[#0F5132] focus:ring-[#0F5132]">
                                                ...
                                                {{-- ✅ OPSI BARU: Filter aktivitas tanpa project --}}
                                                <option value="no_project" {{ request('project_uuid') == 'no_project' ? 'selected' : '' }}>
                                                    📂 Aktivitas Tanpa Project
                                                </option>
                                            </select>
                                        </div>
                                            ...
                                            <tr class="hover:bg-gray-50 transition cursor-pointer" 
                                                ...
                                                <td class="px-4 py-3 text-sm text-gray-900">
                                                    ...
                                                    <div class="text-xs text-gray-500">
                                                        @if($activity->project_id)
                                                            {{ $activity->project->pemilikProject->nama_divisi }}
                                                        @else
                                                            <span class="italic text-yellow-600">Menunggu assignment</span>
                                                        @endif
                                                    </div>
                                                </td>
                                    ...
                                    <div class="bg-gray-50 rounded-lg p-4 border border-gray-200 hover:shadow-md transition cursor-pointer"
                                        ...
                                        <div class="space-y-2 text-xs text-gray-600 mb-3">
                                            ...
                                            <div class="text-right">
                                                @if($activity->project_id)
                                                    <span class="inline-flex items-center px-1.5 py-0.5 bg-green-100 text-green-800 text-xs rounded">
                                                        {{ Str::limit($activity->project->nama_project, 25) }}
                                                    </span>
                                                @else
                                                    <span class="inline-flex items-center px-1.5 py-0.5 bg-yellow-100 text-yellow-800 text-xs rounded">
                                                        {{ Str::limit($activity->placeholder_project_name ?? 'Tanpa Project', 25) }}
                                                    </span>
                                                @endif
                                            </div>
                                        </div>
